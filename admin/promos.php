...
<div class="bar" style="justify-content:space-between">
  <div>
    <h2 style="margin:0">📣 ESENCIA — Promos</h2>
    <small>
      <a href="/sweetpath/admin/orders.php">Pedidos</a> |
      <a href="/sweetpath/admin/products.php">Productos</a> |
      <a href="/sweetpath/admin/config.php">Config</a>
    </small>
  </div>
  <div class="bar">
    <a href="/sweetpath/admin/promo_form.php"><button class="primary" type="button">+ Nueva promo</button></a>
